...
>
    ...
    The most obvious source of the error is the filer in the dust tank of your vacuum. Make sure it is clean and dry. If you have been using your filter for an extended period of time, you might need to swap it out for a new one.
    
    If your filter is clean and dry and you are sure it is not causing the problem, the fix might get a bit more tedious, since we are going to have to disassemble (almost) the whole thing.
