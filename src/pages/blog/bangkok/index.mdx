...
export const meta = {
    ...
    author: "Manuel Gröbl",
    keywords: "Bangkok, Culture, Temple, China Town, Chinese Food, Street Food, City Center, Public Transport, Café, Rimwat Café, Books, Book Store, Wat Phra Chetuphon, Shopping, Shopping Mall, Mall, Pathum Wan, Buddhist Temple, Buddhism, Accommodation, Food, Thai food, Nightlife,  Khaosan road, Red-light, Red-light District, Bangla Road, Khaosan vs. Bangla, Khaosan Road vs. Bangla Road, bar, Ping-pong show, Family Restaurant, vibe,  Things to do, Things to do in Bangkok, World's most visited city, Most visited city, Tourism, Backpacking, Travel, Thailand"
}
